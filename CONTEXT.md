...
### Taxonomy Mapping
A rule that normalizes a raw **Wikidata/Wikipedia category string** to a canonical Topic + Subtopic pair (e.g., `"Jazz musicians"` → `Musical > Jazz`). Applied at import time. Unmapped categories land in a review queue.
